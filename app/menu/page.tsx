...
export default function Page() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-auto bg-gray-900 text-white">
      {/* Background image */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center p-6 w-full md:w-3/5 md:px-28 md:py-12">
              ...
              <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 text-lg font-bold tracking-tight">
                ...
                {menuVisible && (
                  <>
                    ...
                    <Link
                      href="/dashboard"
                      className={`${dm.className} flex items-center gap-3 rounded-lg bg-gradient-to-r from-red-700 via-gray-500 to-gray-700 px-4 py-2 text-sm font-medium text-white shadow-md transition-transform duration-300 hover:scale-105 hover:from-gray-700 hover:via-gray-500 hover:to-gray-700 md:px-6 md:py-3 md:text-base`}
                    >
        ...
        <div className="flex flex-col items-center justify-center mt-10 space-y-6">
          <h2 className={`${dm.className} text-3xl md:text-4xl text-yellow-400 font-bold`}>
            Popular Menus
          </h2>
          <p className={`${dm.className} text-center md:text-2xl md:text-3xl text-white font-bold`}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center mt-10 space-y-6">
