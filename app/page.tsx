...
export default function Page() {
  return (
    <main className="relative flex min-h-screen flex-col p-6">
            ...
            <div className="flex justify-between p-4">
              <div className="text-[1.5rem] md:text-[2rem] leading-[2.5rem] md:leading-[3rem] text-white">
                <ul className="flex items-center">
                  ...
                  <li className={`${dm.className} ml-2 md:ml-4 text-white text-2xl md:text-4xl font-bold bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 bg-clip-text text-transparent animate-pulse`}>
                    <strong>Restaurant NoodleLab</strong>
                  </li>
                </ul>
                <div className="flex items-center space-x-4 text-lg font-bold-tracking-tight">
                  <Link href="/menu">
                    <button className="px-6 py-2 text-white transition-colors bg-gray-800 rounded-full shadow-lg hover:shadow-xl hover:bg-gray-700 md:text-base">Menu</button>
                  </Link>
                </div>
              </div>
              <Link
        ...
        <div className="mt-20 flex grow flex-col gap-4 items-center text-center md:text-left md:items-start md:flex-row">
          <div className="bg-black bg-opacity-50 p-4 rounded-md">
            <p className={`${dm.className} text-lg md:text-xl text-white md:text-3xl md:leading-normal`}>
              <strong className="text-yellow-400">Selamat Datang di Restaurant</strong>. Hanya menyajikan yang terbaik.
            </p>
          </div>
        </div>
      </div>
      ...
      <footer className="relative z-10 mt-12 flex flex-col items-center justify-center w-full bg-black bg-opacity-50 text-white py-6">
