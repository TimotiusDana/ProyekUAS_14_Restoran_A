...
import { ArrowRightIcon, UserGroupIcon, PlusCircleIcon, PhoneIcon, EnvelopeIcon, MapPinIcon } from '@heroicons/react/24/outline';
...
export default function Page() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-auto">
              ...
              {menuVisible && (
                <>
                  ...
                  >
                    ...
                    <span className="hover:text-brown-700">Dashboard Admin</span>
      ...
      {/* Main content */}
      <div className="relative z-10 flex flex-col items-center justify-center flex-grow p-6 w-full md:w-3/5 md:px-28 md:py-12">
        ...
        <div className="flex flex-col items-center justify-center mt-10 space-y-6">
          <p className={`${dm.className} text-center md:text-2xl text-white md:text-3xl md:leading-normal`}>
            <strong className="text-red-400">Kami hanya menggunakan bahan terbaik</strong>. Karena kami tahu Anda ingin sesuatu yang terbaik.
          </p>
          <div className="flex items-center bg-black bg-transparent p-4 rounded-md space-x-4">
            <Image
      ...
      <footer className="relative z-10 flex flex-col items-center justify-center w-full bg-black bg-opacity-50 text-white py-6">
        <div className="text-center">
          <div className="flex items-center justify-center mb-2">
            <PhoneIcon className="w-5 h-5 md:w-6 md:h-6 mr-2" />
            <p className={`${dm.className} text-base md:text-lg`}>Contact Us</p>
          </div>
          <div className="flex items-center justify-center mb-2">
            <EnvelopeIcon className="w-5 h-5 md:w-6 md:h-6 mr-2" />
            <p className={`${dm.className} text-sm md:text-base`}>Email: contact@restaurant.com</p>
          </div>
          <div className="flex items-center justify-center mb-2">
            <PhoneIcon className="w-5 h-5 md:w-6 md:h-6 mr-2" />
            <p className={`${dm.className} text-sm md:text-base`}>Phone: +62 123 4567 890</p>
          </div>
          <div className="flex items-center justify-center mb-2">
            <MapPinIcon className="w-5 h-5 md:w-6 md:h-6 mr-2" />
